...
function About() {
  return (
    <div className=" isolate w-full relative  gap-6">
      <div className="lg:block flex justify-center items-start flex-col  w-full lg:w-auto">
        <img src={dog} className="dog -mr-10" alt="" />
        <div className="lg:h-[700px] pt-7 lg:pl-4 lg:pt-[150px]">
          ...
          <p className="sm:mt-[10px] text-[22px] sm:text-left text-center font-light leading-9 sm:leading-[50px]">
